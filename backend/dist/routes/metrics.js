...
router.get('/dashboard', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    logger_1.logger.info('Fetching dashboard metrics', { userId: "system" });
...
router.get('/trends', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    logger_1.logger.info('Fetching trend metrics', {
        userId: "system",
        period,
        days
    });
...
router.get('/success-rate', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { pipelineId, period = 'day', limit = 30 } = req.query;
    logger_1.logger.info('Fetching success rate metrics', {
        userId: "system",
        pipelineId,
        period
    });
...
router.get('/build-time', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { pipelineId, period = 'day', limit = 30 } = req.query;
    logger_1.logger.info('Fetching build time metrics', {
        userId: "system",
        pipelineId,
        period
    });
...
router.get('/failure-analysis', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { pipelineId, period = 'week' } = req.query;
    logger_1.logger.info('Fetching failure analysis', {
        userId: "system",
        pipelineId,
        period
    });
